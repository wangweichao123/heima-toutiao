<template>
  <el-container class="my-container">
    <!-- 左侧主栏 -->
    <el-aside width="230px" class="my-side">
      <el-container>
        <el-header height="50px" class="my-side-header">
          <img
    ...
    <el-main class="my-main">
      <el-container>
        <el-header height="50px" class="my-main-header">
          <el-row class="my-row">
            <el-col :span="14" class="nav-bar">
              <span>江苏传智播客教育科技股份有限公司</span>
            </el-col>
            <el-col :span="6" class="nav-bar">
              <el-input
                placeholder="请输入内容"
